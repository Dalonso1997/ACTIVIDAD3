...
public class Temperature_converter {
	...
	System.out.println("  Introduce 1 para convertir de celsius a Farenheit....");
	System.out.println("  Introduce 2 para convertir de Farenheit a Celsius....");
	System.out.print("\nIntroduce aqui la opcion...   ");
	...
	if (ans == 2) {
			...
			System.out.print("Tu conversion esta aqui: "+value3+"�C");
		}
	System.out.println("\n\tGracias!!..");
	}
}
